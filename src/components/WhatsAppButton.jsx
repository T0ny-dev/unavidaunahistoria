...
const WhatsAppButton = ({ mensaje }) => {
  const numeroWhatsApp = '5216271080425'; // Número actualizado
  const url = `https://wa.me/${numeroWhatsApp}?text=${encodeURIComponent(mensaje)}`;

  return (
    <a href={url} className="whatsapp-button" target="_blank" rel="noopener noreferrer">
